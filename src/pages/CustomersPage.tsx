        ...
        <table className="w-full text-left border-collapse text-sm">
          <thead>
            <tr className="bg-sky-100/70 border-b border-sky-200 text-sky-900 font-bold uppercase text-[11px] tracking-wider">
              ...
              <th className="hidden sm:table-cell py-3.5 px-4">Budget & Interest</th>
              <th className="hidden lg:table-cell py-3.5 px-4">Sales Executive</th>
              <th className="hidden sm:table-cell py-3.5 px-4">Visit Date</th>
          ...
          <tbody className="divide-y divide-sky-100 text-sky-950">
            {paginatedCustomers.map(c => (
              ...
              >
                ...
                <td className="hidden lg:table-cell py-3.5 px-4 text-xs font-semibold text-sky-900">
                  {c.salesExecutive}
                </td>
